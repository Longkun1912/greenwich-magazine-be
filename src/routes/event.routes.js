...
module.exports = function (app) {
  ...
  ); // Route for creating a new event, accessible only to admins
  app.get(
    "/api/event-management/events",
    [authJwt.verifyToken],
    eventController.getAllEvents
  ); // Route for getting all events, accessible to all authenticated users
  app.put(
    "/api/event-management/events/:id",
    [authJwt.verifyToken, authJwt.isAdmin],
    eventController.updateEvent
  ); // Route for updating an event, accessible only to admins
  app.delete(
    "/api/event-management/events/:id",
    [authJwt.verifyToken, authJwt.isAdmin],
